...
export default function Header() {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 grid h-[102px] grid-cols-2 grid-rows-2 bg-white px-5 pb-[10px] pt-[15px] md:flex md:h-[70px] md:px-8 md:py-[15px]">
      <Link
        href="/"
