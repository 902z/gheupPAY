      ...
      {notices &&
        notices.map((notice) => {
          return (
            ...
            >
              <div className="relative h-[82px] w-[147px] rounded-[12px] md:h-[160px] md:w-[280px]">
                <Image alt="" src={notice.item.shop.item.imageUrl} fill={true} layout="fill" objectFit="cover" />
              </div>
              <data className="py-2 font-bold md:text-l">{notice.item.shop.item.name}</data>
