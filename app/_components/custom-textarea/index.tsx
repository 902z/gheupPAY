  ...
  return (
    <label className="flex w-full flex-col gap-2 text-start text-base font-normal leading-[26px] text-black">
      ...
      <textarea
        ...
        {...register}
        className="h-[153px] border border-solid border-gray-30 pl-5 pt-4 text-base font-normal leading-[26px] text-black placeholder:text-gray-40 focus:outline-primary"
      />
    </label>
  );
}
