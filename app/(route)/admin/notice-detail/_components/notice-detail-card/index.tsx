  ...
  return (
    <>
      ...
      <div className="box-border flex h-fit w-full flex-col rounded-[12px] border border-gray-10 bg-white p-5 lg:flex-row lg:gap-4">
        <div className="relative mb-2 box-border h-[180px] w-full rounded-[12px] md:h-[160px]">
          <Image
            alt=""
      ...
      <div className="mt-4 box-border flex h-fit w-full flex-col rounded-[12px] bg-gray-10 p-5">
